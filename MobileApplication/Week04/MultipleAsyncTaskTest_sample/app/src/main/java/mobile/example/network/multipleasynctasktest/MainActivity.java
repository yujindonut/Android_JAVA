...
//                EditText etDownLink 에 기록한 주소에 접속하여 문자열 data 받아오기
   ...
   /* 문자열 형태의 주소를 전달 받아 네트워크에서 문자열 데이터(이미지 주소)를 받아옴
    ...
    class DataAsyncTask extends AsyncTask<String, Integer, String> implements mobile.example.network.multipleasynctasktest.DataAsyncTask {
       final static String DataAsyncTaskTAG = "DataAsyncTask";
       @Override
       protected void onPreExecute() {
           Log.d(DataAsyncTaskTAG, "Start");
       }
       @Override
       protected String doInBackground(String... strings) {
           Log.i(TAG + " DATA", strings[0]);
           String result = downloadContents(strings[0]);
           return result;
       }
       @Override
       protected void onPostExecute(String result) {
           tvImgLink.setText(result);
           btnImgDownload.setEnabled(true);      // 이미지 다운 버튼 활성화
       }
   }
